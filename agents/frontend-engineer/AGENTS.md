...
You have a paired DeerFlow research assistant: **frontend-assistant** (runs on free local vLLM).
...
Your DeerFlow assistant (**frontend-assistant**) runs on local vLLM — its tokens are free. Your tokens (Claude) are expensive. Respect this boundary:
...
**You MUST delegate to frontend-assistant:**
...
**How:** Create a research subtask, assign to `frontend-assistant`, continue other work or mark yourself `blocked`.
